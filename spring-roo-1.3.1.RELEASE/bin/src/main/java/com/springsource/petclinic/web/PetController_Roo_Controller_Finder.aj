...
privileged aspect PetController_Roo_Controller_Finder {
    ...
    @RequestMapping(params = { "find=ByNameAndWeigth", "form" }, method = RequestMethod.GET)
    public String PetController.findPetsByNameAndWeigthForm(Model uiModel) {
        return "pets/findPetsByNameAndWeigth";
    }
    
    @RequestMapping(params = "find=ByNameAndWeigth", method = RequestMethod.GET)
    public String PetController.findPetsByNameAndWeigth(@RequestParam("name") String name, @RequestParam("weigth") float weigth, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
            uiModel.addAttribute("pets", Pet.findPetsByNameAndWeigth(name, weigth, sortFieldName, sortOrder).setFirstResult(firstResult).setMaxResults(sizeNo).getResultList());
            float nrOfPages = (float) Pet.countFindPetsByNameAndWeigth(name, weigth) / sizeNo;
            uiModel.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
            uiModel.addAttribute("pets", Pet.findPetsByNameAndWeigth(name, weigth, sortFieldName, sortOrder).getResultList());
        }
        return "pets/list";
    }
    ...
    @RequestMapping(params = { "find=BySendRemindersAndWeigthLessThan", "form" }, method = RequestMethod.GET)
    public String PetController.findPetsBySendRemindersAndWeigthLessThanForm(Model uiModel) {
        return "pets/findPetsBySendRemindersAndWeigthLessThan";
    }
    
    @RequestMapping(params = "find=BySendRemindersAndWeigthLessThan", method = RequestMethod.GET)
    public String PetController.findPetsBySendRemindersAndWeigthLessThan(@RequestParam(value = "sendReminders", required = false) boolean sendReminders, @RequestParam("weigth") float weigth, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
            uiModel.addAttribute("pets", Pet.findPetsBySendRemindersAndWeigthLessThan(sendReminders, weigth, sortFieldName, sortOrder).setFirstResult(firstResult).setMaxResults(sizeNo).getResultList());
            float nrOfPages = (float) Pet.countFindPetsBySendRemindersAndWeigthLessThan(sendReminders, weigth) / sizeNo;
            uiModel.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
            uiModel.addAttribute("pets", Pet.findPetsBySendRemindersAndWeigthLessThan(sendReminders, weigth, sortFieldName, sortOrder).getResultList());
        }
        return "pets/list";
    }
